...
exports.createFirstMigration = function(projectDir, modelName, attribs) {
	modelName = require('inflection').camelize(modelName);
...
exports.createMigration = function(projectDir, modelName) {

	fs.copy(jetpack.jetpackDir + '/skeletons/migrations/migration.js', 
			projectDir + '/db/migrate/' + jetpack.util.getTimestamp() 
			+ '_' + modelName  + '.js');
}
